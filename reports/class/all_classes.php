...
try{
        ...
        $pdf->SetTitle('Classes ~ Summary Report');
        $pdf->SetSubject("summary classes report");
        ...
        $pdf->Cell(0, 8, "SUMMARY CLASS REPORT",$border=1,$ln=1,'C',$fill=true, $link='', $stretch=0, $ignore_min_height=true, $calign='T', $valign='B');
        $pdf->SetFont('aefurat', 'B', 10);
        $pdf->Cell(68, 10, 'Total Number of Classes : '. $student_count[0]["StudentCount"] . '  ', $border=1,$ln=0,'L',$fill=true, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='C');
...
try{
    ...
    $pdf->Cell($width_cell[2], 10, 'CLASS NAME',$border=1,$ln=0,'L',$fill=true, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='R');
    $pdf->Cell($width_cell[2], 10, '#CLASS',$border=1,$ln=0,'L',$fill=true, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='R');
    $pdf->Cell($width_cell[0], 10, 'DATE ADDED',$border=1,$ln=1,'R',$fill=true, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='R');
    ...
    foreach ($dbh->query($sql) as $row) {
        ...
        $pdf->Cell($width_cell[2], 10, $row['name'], $border=1,$ln=0,'L',$fill=$fill, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='R');
        $pdf->Cell($width_cell[2], 10, $row['classes'], $border=1,$ln=0,'L',$fill=$fill, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='R');
        $pdf->Cell($width_cell[0], 10, $row['created_at'], $border=1,$ln=1,'R',$fill=$fill, $link='', $stretch=0, $ignore_min_height=false, $calign='T', $valign='R');
